...
class dustbin {
    ...
    constructor(x,y) {
        ...
        part1.width = 150;
        part1.height = 20;
        this.part1img = loadImage("dustbingreen.png")
    
        part2 = Bodies.rectangle(x+60, y-15, 20,150, options);
        part2.width = 20;
        part2.height = 100;

        part3 = Bodies.rectangle(x-60, y-15, 20, 100, options);
        part3.width = 20;
        part3.height = 100;
    ...
    display(){
        ...
        rectMode(CENTER);
        fill("white");
        image(this.part1img,-85,-110,part1.width+10,120);
        pop();
      }
    }
